...
pandoc WARNING_EN/CHAPTERS/*.md WARNING_EN/PAPERS/*.md -s -o WarNing_english.pdf --pdf-engine=weasyprint 
...
pandoc WARNING_FR/CHAPTERS/*.md WARNING_FR/PAPERS/*.md -s -o WarNing_francais.pdf --pdf-engine=weasyprint 
